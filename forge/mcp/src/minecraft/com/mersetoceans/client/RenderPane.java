...
public class RenderPane implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        ...
        float var7 = 1.0F;
        int var8 = block.colorMultiplier(world, x, y, z);
        ...
        {
            var65 = renderer.overrideBlockTexture;
            var66 = renderer.overrideBlockTexture;
        }
        else
        {
            var68 = world.getBlockMetadata(x, y, z);
            var65 = block.getBlockTextureFromSideAndMetadata(0, var68);
            var66 = ((BlockPaneMO) block).getSideTextureIndex();
        }
        ...
        boolean var58 = ((BlockPaneMO) block).canThisPaneConnectToThisBlockID(world.getBlockId(x, y, z - 1));
        boolean var59 = ((BlockPaneMO) block).canThisPaneConnectToThisBlockID(world.getBlockId(x, y, z + 1));
        boolean var60 = ((BlockPaneMO) block).canThisPaneConnectToThisBlockID(world.getBlockId(x - 1, y, z));
        boolean var61 = ((BlockPaneMO) block).canThisPaneConnectToThisBlockID(world.getBlockId(x + 1, y, z));
        boolean var62 = block.shouldSideBeRendered(world, x, y + 1, z, 1);
        boolean var63 = block.shouldSideBeRendered(world, x, y - 1, z, 0);
	...
	@Override
	public int getRenderId() { return ClientProxy.RENDERPANE; }
