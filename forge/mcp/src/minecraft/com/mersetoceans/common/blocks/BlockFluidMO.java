...
public class BlockFluidMO extends BlockContainer {
	
    protected BlockFluidMO(int par1, Material par2Material)
    {
    ...
    public static double getFlowDirection(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, Material par4Material)
    {
        ...
        {
            var5 = ((BlockFluidMO)Block.waterMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }

        if (par4Material == Material.lava)
        {
            var5 = ((BlockFluidMO)Block.lavaMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }
