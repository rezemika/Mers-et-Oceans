...
public class BlockTorchMO extends BlockMO {
    ...
    private boolean canPlaceTorchOn(World world, int par2, int par3, int par4) {
        if (world.doesBlockHaveSolidTopSurface(par2, par3, par4))
            return true;
        else {
            int var5 = world.getBlockId(par2, par3, par4);
            return (Block.blocksList[var5] != null && Block.blocksList[var5].canPlaceTorchOnTop(world, par2, par3, par4));
        }
    }
