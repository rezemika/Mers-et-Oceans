...
import com.mersetoceans.common.dimension.structure.MapGenAbyssesBridge;

public class ChunkProviderAbysses implements IChunkProvider
{
    ...
    public MapGenAbyssesBridge genAbyssesBridge = new MapGenAbyssesBridge();
    ...
    private MapGenBase abyssesCaveGenerator = new MapGenCavesAbysses();
    double[] noiseData1;
    double[] noiseData2;
    double[] noiseData3;
    double[] noiseData4;
    ...
    {
        genAbyssesBridge = (MapGenAbyssesBridge) TerrainGen.getModdedMapGen(genAbyssesBridge, NETHER_BRIDGE);
        abyssesCaveGenerator = TerrainGen.getModdedMapGen(abyssesCaveGenerator, NETHER_CAVE);
    }

    public ChunkProviderAbysses(World par1World, long par2)
    {
     ...
     */
    public void generateAbyssesTerrain(int par1, int par2, byte[] par3ArrayOfByte)
    {
        byte var4 = 4;
        byte var5 = 32;
        int var6 = var4 + 1;
                    ...
                    for (int var30 = 0; var30 < 8; ++var30)
                    {
                        ...
                        for (int var41 = 0; var41 < 4; ++var41)
                        {
                            ...
                            for (int var50 = 0; var50 < 4; ++var50)
                            {
                                ...
                                if (var46 > 0.0D)
                                    var51 = MersEtOceans.rocklisse.blockID;
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte)
    {
        ...
        for (int var7 = 0; var7 < 16; ++var7)
        {
            for (int var8 = 0; var8 < 16; ++var8)
            {
                ...
                int var12 = -1;
                byte var13 = (byte)MersEtOceans.terreAbysse.blockID;
                byte var14 = (byte)MersEtOceans.terreAbysse.blockID;
                ...
                for (int var15 = 127; var15 >= 0; --var15)
                {
                    ...
                    if (var15 < 127 - this.hellRNG.nextInt(5) && var15 > 0 + this.hellRNG.nextInt(5))
                    {
                        ...
                        if (var17 == 0) {
                            ...
                            if (var12 == -1)
                            {
                                ...
                                {
                                    var13 = 0;
                                    var14 = (byte)MersEtOceans.terreAbysse.blockID;
                                }
                                else if (var15 >= var4 - 4 && var15 <= var4 + 1)
                                {
                                    var13 = (byte)MersEtOceans.rock.blockID;
                                    var14 = (byte)MersEtOceans.rock.blockID;
                                    ...
                                    if (var9) {
                                        var13 = (byte)MersEtOceans.basalte.blockID;
                                        var14 = (byte)MersEtOceans.basalte.blockID;
                                    }
                                }

                                if (var15 < var4 && var13 == 0)
                                {
                                    var13 = (byte)MersEtOceans.waterStill.blockID;
                                }
                    ...
                    byte var17 = par3ArrayOfByte[var16];
                    //if (var15 < 127 && var15 > 0 && var17 == 0)
                    //	par3ArrayOfByte[var16] = (byte) MersEtOceans.waterStill.blockID;
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        byte[] id = new byte[32768];
        this.generateAbyssesTerrain(par1, par2, id);
        this.replaceBlocksForBiome(par1, par2, id);
        this.abyssesCaveGenerator.generate(this, this.worldObj, par1, par2, id);
        this.genAbyssesBridge.generate(this, this.worldObj, par1, par2, id);
        Chunk var4 = new Chunk(this.worldObj, id, par1, par2);
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        int var4 = par2 * 16;
        int var5 = par3 * 16;
        this.genAbyssesBridge.generateStructuresInChunk(this.worldObj, this.hellRNG, par2, par3);
        int var6;
        int var7;
        int var8;
        int var9;
        ...
        boolean doGen = TerrainGen.populate(par1IChunkProvider, worldObj, hellRNG, par2, par3, false, GLOWSTONE);
    ...
    {
        if (par1EnumCreatureType == EnumCreatureType.monster && this.genAbyssesBridge.hasStructureAt(par2, par3, par4))
        {
            return this.genAbyssesBridge.getSpawnList();
        }
        else
        {
    ...
    {
        this.genAbyssesBridge.generate(this, this.worldObj, par1, par2, (byte[])null);
    }
}