...
public class StructureAbyssesBridgePieceWeight {
    ...
    public StructureAbyssesBridgePieceWeight(Class par1Class, int par2, int par3, boolean par4)
    {
    ...
    public StructureAbyssesBridgePieceWeight(Class par1Class, int par2, int par3)
    {
