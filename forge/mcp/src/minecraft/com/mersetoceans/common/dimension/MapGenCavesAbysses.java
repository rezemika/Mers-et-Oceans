...
public class MapGenCavesAbysses extends MapGenBase {
                        ...
                        for (int var41 = var55; !var54 && var41 < var38; ++var41) {
                            for (int var42 = var36 + 1; !var54 && var42 >= var53 - 1; --var42) {
                                ...
                                if (var42 >= 0 && var42 < 128) {
                                    if (par3ArrayOfByte[var43] == Block.waterMoving.blockID || par3ArrayOfByte[var43] == Block.waterStill.blockID)
                                        var54 = true;
                            ...
                            for (var43 = var55; var43 < var38; ++var43) {
                                ...
                                for (int var47 = var36 - 1; var47 >= var53; --var47) {
                                    ...
                                    if (var48 > -0.7D && var56 * var56 + var48 * var48 + var44 * var44 < 1.0D) {
                                        ...
                                        //if( var50 != 0 ) {
                                        //	System.err.println(var46);
                                        //	System.err.println(var50);
                                        //}

                                        if (var50 == MersEtOceans.rocklisse.blockID || var50 == MersEtOceans.terreAbysse.blockID || var50 == MersEtOceans.terreAbysse.blockID)
    ...
    protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, byte[] par6ArrayOfByte) {
        ...
        if (this.rand.nextInt(5) != 0) var7 = 0;
