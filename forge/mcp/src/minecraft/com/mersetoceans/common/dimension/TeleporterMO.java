...
public class TeleporterMO extends Teleporter {
	...
	public TeleporterMO(WorldServer par1WorldServer) {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
			...
			for (var48 = var15 - var9; var48 <= var15 + var9; ++var48) {
				...
				for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23) {
					...
					for (int var26 = this.field_85192_a.getActualHeight() - 1; var26 >= 0; --var26) {
						if (this.field_85192_a.getBlockId(var48, var26, var23) == MersEtOceans.portal.blockID) {
							while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == MersEtOceans.portal.blockID)
								--var26;
		...
		if (var10 >= 0.0D) {
			...
			if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == MersEtOceans.portal.blockID)
				var50 = 2;
			
			if (this.field_85192_a.getBlockId(var12 + 1, var13, var14) == MersEtOceans.portal.blockID)
				var50 = 0;
			
			if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == MersEtOceans.portal.blockID)
				var50 = 3;
	...
	public boolean func_85188_a(Entity par1Entity) {
		...
		for (var19 = 0; var19 < 4; ++var19) {
			...
			for (var21 = -1; var21 < 4; ++var21) {
				...
				this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? Block.sandStone.blockID : MersEtOceans.portal.blockID);
			}
