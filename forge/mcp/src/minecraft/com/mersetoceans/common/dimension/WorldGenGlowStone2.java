...
public class WorldGenGlowStone2 extends WorldGenerator
{
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        else if (par1World.getBlockId(par3, par4 + 1, par5) != MersEtOceans.rocklisse.blockID)
        {
            return false;
        }
        else
        {
            par1World.setBlockWithNotify(par3, par4, par5, MersEtOceans.glowstoneAberlan.blockID);
            ...
            for (int var6 = 0; var6 < 1500; ++var6)
            {
                ...
                if (par1World.getBlockId(var7, var8, var9) == 0)
                {
                    ...
                    for (int var11 = 0; var11 < 6; ++var11)
                    {
                        ...
                        if (var12 == MersEtOceans.glowstoneAberlan.blockID)
                        {
                            ++var10;
                        }
                    }
                    ...
                    if (var10 == 1)
                    {
                        par1World.setBlockWithNotify(var7, var8, var9, MersEtOceans.glowstoneAberlan.blockID);
                    }
                }
            }
